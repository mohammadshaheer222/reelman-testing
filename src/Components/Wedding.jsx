    ...
    <div className="px-8 w-full ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 h-full ">
        {wedding.map((wedding, index) => (
          <div
            key={index}
            className="cursor-pointer scale-95 hover:scale-100 transition-all duration-1000 overflow-hidden shadow-sm"
          >
            <img
              ...
              alt=""
            />
            <p className="heading text-center tracking-tight font-medium block md:text-lg">
              {wedding.quote} - <br />
