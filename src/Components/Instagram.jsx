      ...
      <div className="grid grid-cols-3 h-24 w-full md:grid-cols-6 pt-4">
        {carousel.map((img) => (
          <div className="p-0.5 relative cursor-pointer group">
            <img
              className="hover:scale-105 transition-all duration-1000 object-cover w-64 h-72"
              src={img.images}
              alt=""
            />
            ...
            <div className="scale-0 group-hover:scale-100 duration-500 absolute top-1/2 right-1/2">
              <FaInstagram
                size={30}
                className=" text-white scale-125 hover:rotate-90 transition-all duration-500"
              />
            </div>
          </div>
        ))}
